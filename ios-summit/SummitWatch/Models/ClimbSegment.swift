...
/// A sustained climb found in a course's elevation profile.
///
/// Climbs are detected from the route the athlete actually loaded, so every
/// number here — length, gain, gradient — comes from surveyed elevation rather
/// than a guess about the terrain ahead.
