            ...
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text(route.name)
                        ...
                        .lineLimit(1)
                    Text("\(Formatters.distance(route.distance)) \(Formatters.units.distanceUnit) · \(Formatters.elevation(route.elevationGain)) \(Formatters.elevationUnit) ↑")
                        .font(.caption2)
                        .monospacedDigit()
        ...
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 5) {
                Text(route.name)
                    ...
                    .foregroundStyle(Theme.textPrimary)
                    .lineLimit(1)
                Text("\(Formatters.distance(route.distance)) \(Formatters.units.distanceUnit) · \(Formatters.elevation(route.elevationGain)) \(Formatters.elevationUnit) ↑ · \(Formatters.compactDuration(route.estimatedDuration))")
                    .font(.caption)
                    .monospacedDigit()
                    .foregroundStyle(Theme.textPrimary.opacity(0.55))
                HStack(spacing: 8) {
